          ...
          <div className="relative bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <div className="space-y-3">
              {recentActivity.map((activity, index) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${activity.result === 'safe' ? 'bg-emerald-500/20 border border-emerald-500/30' :
              ...
              {threatAlerts.map((alert, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <AlertTriangle className={`w-5 h-5 flex-shrink-0 ${alert.severity === 'high' ? 'text-red-400' : 'text-amber-400'
                      }`} />
                    <div className="flex-1">
